...
function View:setup_view()
  ...
  vim.api.nvim_buf_set_option_value(self.bufnr, "bufhidden", "delete")
  -- create a split
  ...
  -- window stuff
  vim.api.nvim_win_set_option_value(self.winnr, "number", false)
  vim.api.nvim_win_set_option_value(self.winnr, "relativenumber", false)
  vim.api.nvim_win_set_option_value(self.winnr, "winfixwidth", true)
  vim.api.nvim_win_set_option_value(self.winnr, "list", false)
  vim.api.nvim_win_set_option_value(self.winnr, "wrap", config.options.wrap)
  vim.api.nvim_win_set_option_value(self.winnr, "linebreak", true)   -- only has effect when wrap=true
  vim.api.nvim_win_set_option_value(self.winnr, "breakindent", true) -- only has effect when wrap=true
  ...
  vim.api.nvim_win_set_option_value(self.winnr, "showbreak", "      ") -- only has effect when wrap=true.
  -- buffer stuff
  vim.api.nvim_buf_set_name(self.bufnr, "OUTLINE")
  vim.api.nvim_buf_set_option_value(self.bufnr, "filetype", "Outline")
  vim.api.nvim_buf_set_option_value(self.bufnr, "modifiable", false)

  if config.options.show_numbers or config.options.show_relative_numbers then
    vim.api.nvim_win_set_option_value(self.winnr, "nu", true)
  end

  if config.options.show_relative_numbers then
    vim.api.nvim_win_set_option_value(self.winnr, "rnu", true)
  end
end
